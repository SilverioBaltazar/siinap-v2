...
class progtrabController extends Controller
{
    ...
    public function actionBuscarProgtrab(Request $request)
    {
        ...
        return view('sicinar.programatrabajo.verProgtrab', compact('nombre','usuario','regiap','reganios','regperiodos','regmeses','regdias','regprogtrab','totactivs'));
    }
    ...
    public function actionVerProgtrab(){
        ...
        //return view('sicinar.programatrabajo.verProgtrab',compact('nombre','usuario','regiap','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab'));
        return view('sicinar.programatrabajo.verProgtrab',compact('nombre','usuario','regiap','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab','totactivs')); 
    ...
    public function actionExportProgtrabPdf($id,$id2){
        ...
        if($regprogdtrab->count() <= 0){
            ...
            $pdf = PDF::loadView('sicinar.pdf.ProgtrabPdf',compact('nombre','usuario','regumedida','regiap','regprogtrab','regprogdtrab'));
            //$options = new Options();
    ...
    public function actionVerProgdtrab($id){
        ...
        //return view('sicinar.programatrabajo.verProgtrab',compact('nombre','usuario','regiap','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab'));
        return view('sicinar.programatrabajo.verProgdtrab',compact('nombre','usuario','regiap','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab'));
    }
    ...
    public function actionEditarProgdtrab($id,$id2){
        ...
        //return view('sicinar.programatrabajo.editarProgtrab',compact('nombre','usuario','regiap','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab'));
        return view('sicinar.programatrabajo.editarProgdtrab',compact('nombre','usuario','regiap','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab','regumedida'));
