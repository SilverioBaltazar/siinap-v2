...
class iapsjuridicoRequest extends FormRequest
{
    public function messages()
    {
        return [
            ...
            'iap_rfc.required' => 'Archivo del RFC ante el SAT en formato PDF es obligatorio'
        ];
    }
    /**
    ...
    public function rules()
    {
        return [
            ...
            'iap_rfc'       => 'required',
            'iap_rfc'       => 'sometimes|mimetypes:application/pdf|max:2048',
            'iap_rfc'       => 'sometimes|mimetypes:pdf|max:2048',
            'iap_rfc'       => 'sometimes|mimes:application/pdf|max:2048',
            'iap_rfc'       => 'sometimes|mimes:pdf|max:2048'
            //'inm_id'        => 'required'
