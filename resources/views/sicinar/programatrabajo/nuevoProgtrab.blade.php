    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                ...
                <small> Programa trabajo - Nuevo</small>                
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => 'AltaNuevoProgtrab', 'method' => 'POST','id' => 'nuevoProgtrab', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 form-group">
                                    <label >Elaboro </label>
                                    <input type="text" class="form-control" name="elaboro" id="elaboro" placeholder="Elaboro" onkeypress="return soloAlfa(event)" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Autorizo </label>
                                    <input type="text" class="form-control" name="autorizo" id="autorizo" placeholder="Autorizo" onkeypress="return soloLetras(event)" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 form-group">
                                    ...
                                    <textarea class="form-control" name="obs_1" id="obs_1" rows="2" cols="120" placeholder="Objetivo (300 carácteres)" required>
                                    </textarea>
                                </div>                                
                            </div>                                                        
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\progtrabRequest','#nuevoProgtrab') !!}
@endsection
