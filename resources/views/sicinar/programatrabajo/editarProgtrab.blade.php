    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <small> - editar programa de trabajo </small>           
            </h1>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Editar programa de trabajo </h3>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">   
                                <div class="col-xs-4 form-group">
                                    ...
                                    <td style="text-align:left; vertical-align: middle;">   
                                        @foreach($regperiodos as $periodo)
                                            @if($periodo->periodo_id == $regprogtrab->periodo_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <td style="text-align:left; vertical-align: middle;">   
                                        @foreach($regiap as $iap)
                                            @if($iap->iap_id == $regprogtrab->iap_id)
                                                {{$iap->iap_desc}}
                                                @break
                                            @endif
                                        @endforeach
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="folio" id="folio" placeholder="Folio asignado" value="{{$regprogtrab->folio}}" >
                                </div>    
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 form-group">
                                    <label >Elaboro </label>
                                    <input type="text" class="form-control" name="elaboro" id="elaboro" placeholder="Elaboro" value="{{trim($regprogtrab->elaboro)}}" onkeypress="return soloAlfa(event)" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Autorizo </label>
                                    <input type="text" class="form-control" name="autorizo" id="autorizo" placeholder="Autorizo" value="{{trim($regprogtrab->autorizo)}}" onkeypress="return soloLetras(event)" required>
                                </div>
                            </div>
