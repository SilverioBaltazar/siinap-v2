...
<!--<body>-->
  <!--<style type="text/css">
    body{
    background-image: url("{{asset('images/indice2.png')}}");
    height: 50%;
  ...
  <div class="login-box">
    ...
    <div class="login-logo">
      <a href="#"><b style="color:green;">SIINAP V.2</b></a>
    ...
    <div class="login-logo"><br>
      ...
      <!--<b style="color:blue;"><h3>SISTEMA DE CONTROL INTERNO Y ADMINISTRACIÓN DE RIESGOS</h3></b>-->
      <h4 style="color:green;"><b>SECRETARIA DE DESARROLLO SOCIAL - JUNTA DE ASISTENCIA PRIVADA (JAPEM)</b></h4>
    </div>
  </div>
