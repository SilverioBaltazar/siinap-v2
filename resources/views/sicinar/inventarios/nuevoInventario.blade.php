...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                <small>Requisitos contables - Inventario de activos fijos - Registrar</small>
            </h1>
        </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    <label >Código, clave o id. del activo fijo  (25 carácteres)</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2 form-group">
                                    ...
                                    <input type="number" min="0" max="999999999999.99" class="form-control" name="activo_valor" id="activo_valor" placeholder="Valor del activo fijo"  required>
                                </div>                                                                
                            </div>                                                        
