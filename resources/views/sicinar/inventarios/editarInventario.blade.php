...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <h1>
                Menú
                <small>Requisitos contables - Inventario de activos fijos - Editar</small>
            </h1>
        </section>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">                       
                            <div class="col-xs-8 form-group" style="text-align:left; vertical-align: middle;color:green;">
                                <label>Código, clave o id. del activo fijo: {{$reginventario->activo_id}}</label>
                            </div>                                             
                            <div class="col-xs-2 form-group" style="text-align:right; vertical-align: middle;color:green;">
                                <input type="hidden" id="id" name="id" value="{{$reginventario->id}}">  
                                <label>Id. sistema: {{$reginventario->id}}</label>
                            </div>
                                ...
                                <div class="col-xs-8 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="iap_id" id="iap_id" required>
                                        ...
                                        @foreach($regiap as $iap)
                                            @if($iap->iap_id == $reginventario->iap_id)
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 form-group">
                                    ...
                                    <input type="number" min="0" max="999999999999.99" class="form-control" name="activo_valor" id="activo_valor" placeholder="Digitar el valor del activo fijo" value="{{Trim($reginventario->activo_valor)}}"  required>
                                </div>                                                                
                            </div>                          
