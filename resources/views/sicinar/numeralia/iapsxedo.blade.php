...
@section('title','Estadística por estado')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">IAPS por estado </li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Estadística de IAPS por estado</b></h3>
              ...
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                  @foreach($regiap as $iap)
                    <tr>
                      <td style="color:darkgreen;">{{$iap->entidadfederativa_id}}</td>
                      <td style="color:darkgreen;">{{$iap->estado}}   </td>
                  ...
                  @foreach($regtotxedo as $totales)
                     <tr>
                        ...
                        <td style="color:green; text-align:center;"><b>{{$totales->totalxedo}} </b></td>
                     </tr>
                  @endforeach
                </tbody>
              </table>
  ...
  <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: { title: 'Gráfica por estado 2D',
                   subtitle: 'Cantidad de IAPS por Estado' },
