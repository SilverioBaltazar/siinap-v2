...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                <small> Catálogos - Procesos - Nuevo</small>                
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header"><h3 class="box-title">Registrar nuevo proceso</h3></div>
                        {!! Form::open(['route' => 'AltaNuevoProceso', 'method' => 'POST','id' => 'nuevoProceso']) !!}
                        <div class="box-body">
                            <div class="row">
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\catalogosRequest','#nuevoProceso') !!}
@endsection
