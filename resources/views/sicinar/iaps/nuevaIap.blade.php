                        ...
                        <div class="box-body">
                            ...
                            <div class="row">                                
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="iap_feccons2" id="iap_feccons2" placeholder="dd/mm/aaaa" required>
                                </div>                                                                 
                                <div class="col-xs-4 form-group">
                                    <label >Fecha de vencimiento del Patronato (dd/mm/aaaa) </label>
                                    <input type="text" class="form-control" name="iap_fvp2" id="iap_fvp2" placeholder="dd/mm/aaaa" required>
                                </div>                                  
                            </div>
