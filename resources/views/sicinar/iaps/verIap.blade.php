                    ...
                    <div class="box">
                        ...
                        <div class="page-header" style="text-align:right;">
                            ...
                            {{ Form::open(['route' => 'buscarIap', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                ...
                                <div class="form-group">
                                    <a href="{{route('downloadiap')}}" class="btn btn-success" title="Exportar catálogo de IAPS (formato Excel)"><i class="fa fa-file-excel-o"></i> Excel
                                    </a>                            
                                    <a href="{{route('nuevaIap')}}" class="btn btn-primary btn_xs" title="Alta nueva IAP"><i class="fa fa-file-new-o"></i><span class="glyphicon glyphicon-plus"></span>Nueva IAP
                                    </a>
                                </div>                                
                            {{ Form::close() }}
                        </div>
