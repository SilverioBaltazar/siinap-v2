...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                <small>IAPS - Registro de Datos jurídicos </small>
            </h1>
        </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">   
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="datepicker1"  name="iap_fvp" placeholder="Fecha de vencimiento del Patronato (dd/mm/aaaa)" required>
                                    </div>
                                </div>                                                            
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 offset-md-5">
                                    {!! Form::submit('Registrar datos jurícos ',['class' => 'btn btn-success btn-flat pull-right']) !!}
