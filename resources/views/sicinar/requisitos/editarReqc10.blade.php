            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc10',$regcontable->iap_id], 'method' => 'PUT', 'id' => 'actualizarReqc10', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regcontable->iap_d10)||!is_null($regcontable->iap_d10))   
                                    <div class="col-xs-4 form-group">
                                        <label >Cuotas 5 al millar en formato PDF</label><br>
                                        <label ><a href="/images/{{$regcontable->iap_d10}}" class="btn btn-danger" title="Cuotas 5 al millar en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                    ...
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d10" id="iap_d10" placeholder="Subir archivo de Cuotas 5 al millar en formato PDF" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Cuotas 5 al millar en formato Excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d10" id="iap_d10" placeholder="Subir archivo de Cuotas 5 al millar en formato PDF" >
                                        <input type="hidden" name="doc_id10" id="doc_id10" value="15">
                                    </div>                                                
                                @endif 
                            ...
                            <div class="row">        
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="preg_006" id="preg_006" placeholder="Monto en pesos $ mexicanos de la aportación monetaria" value="{{$regcontable->preg_006}}" required>
                                </div>                                                                        
                            </div>                                                                       
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontablesRequest','#actualizarRec10') !!}
@endsection
