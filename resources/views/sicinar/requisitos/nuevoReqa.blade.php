                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="preg_007" id="preg_007" placeholder="Total de hombres" required>
                                </div>                                                          
                                <div class="col-xs-4 form-group">
                                    <label >Total de mujeres </label>
                                    <input type="text" class="form-control" name="preg_008" id="preg_008" placeholder="Total de mujeres" required>
                                </div>   
                            </div>                                    
                            <div class="row">                                                                       
                                <div class="col-xs-4 form-group">
                            ...
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="preg_009" id="preg_009" placeholder="Total de personal remunerado" required>
                                </div>                                                          
                                <div class="col-xs-4 form-group">
                                    <label >Total de personal voluntario </label>
                                    <input type="text" class="form-control" name="preg_010" id="preg_010" placeholder="Total de personal voluntario" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Total de personal administrativo </label>
                                    <input type="text" class="form-control" name="preg_011" id="preg_011" placeholder="Total de personal administrativo" required>
                                </div>                                   
                            </div>
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    <label >Total de personal operativo </label>
                                    <input type="text" class="form-control" name="preg_012" id="preg_012" placeholder="Total de personal operativo" required>
                                </div>                                                          
                                <div class="col-xs-4 form-group">
                                    <label >Monto en $ persos mexicanos del personal administrativo </label>
                                    <input type="text" class="form-control" name="preg_013" id="preg_013" placeholder="Monto en $ pesos mexicanos del personal administrativo" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Monto en $ persos mexicanos del personal operativo </label>
                                    <input type="text" class="form-control" name="preg_014" id="preg_014" placeholder="Monto en $ persos mexicanos del personal operativo" required>
                                </div>                                   
                            </div>                                                                     
                            <div class="row">                                                                       
                                <div class="col-xs-4 form-group">
