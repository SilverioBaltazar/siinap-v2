            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc9',$regcontable->iap_id], 'method' => 'PUT', 'id' => 'actualizarReqc9', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regcontable->iap_d9)||!is_null($regcontable->iap_d9))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regcontable->iap_d9}}" class="btn btn-danger" title="Declaración anual en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
