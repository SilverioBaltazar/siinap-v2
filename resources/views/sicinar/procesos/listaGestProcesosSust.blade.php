...
@section('title','Gestionar Procesos Sustantivos')
...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Gestión de Procesos Sustantivos
                                ...
                                @foreach($procesos as $proceso)
                                    <tr>
                                        ...
                                        @if($proceso->status_2 == 'A')
                                            <td><a href="{{route('procesosGestionDesSust',$proceso->cve_proceso)}}" class="btn btn-success" title="Activo"><i class="fa fa-check-square-o"></i></a></td>
                                        @else
