            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d01)||!is_null($regasyc->iap_d01))  
                                    <div class="col-xs-4 form-group">
                                        <label >Padrón de beneficiarios </label>
                                        <label ><a href="/images/{{$regasyc->iap_d01}}" class="btn btn-danger" title="Padron de beneficiarios"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Aactualizar archivo de padron de beneficiarios </label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d01" id="iap_d01" placeholder="Subir archivo de Padron de beneficiarios" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de beneficiarios </label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d01" id="iap_d01" placeholder="Subir archivo de Padron de beneficiarios" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per01_id" id="per01_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per01_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num01_id" id="num01_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num01_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc') !!}
@endsection
