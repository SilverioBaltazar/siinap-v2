            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc8',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc8', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d08)||!is_null($regasyc->iap_d08))  
                                    <div class="col-xs-4 form-group">
                                        <label >Constancia de cumplimiento de declaración ante el SAT en formato PDF</label>
                                        <label ><a href="/images/{{$regasyc->iap_d08}}" class="btn btn-danger" title="Constancia de cumplimiento de declaración ante el SAT en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Constancia de cumplimiento de declaración ante el SAT en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d08" id="iap_d08" placeholder="Subir archivo de Constancia de cumplimiento de declaración ante el SAT en formato PDF" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Constancia de cumplimiento de declaración ante el SAT en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d08" id="iap_d08" placeholder="Subir archivo de Constancia de cumplimiento de declaración ante el SAT en formato PDF" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per08_id" id="per08_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per08_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num08_id" id="num08_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num08_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc8') !!}
@endsection
