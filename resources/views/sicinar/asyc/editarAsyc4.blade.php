            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc4',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc4', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d04)||!is_null($regasyc->iap_d04))  
                                    <div class="col-xs-4 form-group">
                                        <label >Inventario de activo fijo en formato excel</label>
                                        <label ><a href="/images/{{$regasyc->iap_d04}}" class="btn btn-danger" title="Inventario de activo fijo en formato excel"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Inventario de activo fijo en formato excel</label>
                                ...
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Inventario de activo fijo en formato excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d04" id="iap_d04" placeholder="Subir archivo de Inventario de activo fijo formato excel" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per04_id" id="per04_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per04_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num04_id" id="num04_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num04_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc4') !!}
@endsection
