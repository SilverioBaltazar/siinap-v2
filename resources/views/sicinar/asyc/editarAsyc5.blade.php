            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc5',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc5', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d05)||!is_null($regasyc->iap_d05))  
                                    <div class="col-xs-4 form-group">
                                        <label >Presupuesto anual en formato excel</label>
                                        <label ><a href="/images/{{$regasyc->iap_d05}}" class="btn btn-danger" title="Presupuesto anual en formato excel"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                ...
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d05" id="iap_d05" placeholder="Subir archivo de Presupuesto anual formato excel" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per05_id" id="per05_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per05_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num05_id" id="num05_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num05_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc5') !!}
@endsection
