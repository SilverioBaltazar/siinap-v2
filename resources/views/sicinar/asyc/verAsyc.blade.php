    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Asistencia social y Contable
                <small> Seleccionar registro para editar o registrar nueva información de asistencia social y contable</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header" style="text-align:right;">
                            <a href="{{route('nuevaAsyc')}}"   class="btn btn-primary btn_xs" title="Registrar datos de asistencia social y contable"><i class="fa fa-file-new-o"></i><span class="glyphicon glyphicon-plus"></span>Registrar datos de aistencia social y contable</a>
                        </div>                        
                                        ...
                                        <tr>
                                           <td style="text-align:left; vertical-align: middle;">{{$asyc->iap_folio}}</td> 
                                            ...
                                            @if(!empty($asyc->iap_d01)&&(!is_null($asyc->iap_d01)))
                                                ...
                                                <a href="/images/{{$asyc->iap_d01}}" class="btn btn-success width:80px; height:20px;" title="Padron de beneficiarios"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d02)&&(!is_null($asyc->iap_d02)))
                                                ...
                                                <a href="/images/{{$asyc->iap_d02}}" class="btn btn-success" title="Lista de personal"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d03)&&(!is_null($asyc->iap_d03)))
                                                ...
                                                <a href="/images/{{$asyc->iap_d03}}" class="btn btn-success" title="Necesidades de capacitación"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d04)&&(!is_null($asyc->iap_d04)))
                                                <td style="color:darkgreen;text-align:center; vertical-align: middle;" title="Inventario de activo fisico">
                                                    <a href="/images/{{$asyc->iap_d04}}" class="btn btn-success" title="Inventario de activo fisico"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d05)&&(!is_null($asyc->iap_d05)))
                                                <td style="color:darkgreen;text-align:center; vertical-align: middle;" title="Presupuesto anual">
                                                    <a href="/images/{{$asyc->iap_d05}}" class="btn btn-success" title="Presupuesto anual"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d06)&&(!is_null($asyc->iap_d06)))
                                                <td style="color:darkgreen;text-align:center; vertical-align: middle;" title="Programa de trabajo">
                                                    <a href="/images/{{$asyc->iap_d06}}" class="btn btn-success" title="Programa de trabajo"><i class="fa fa-file-excel-o"></i>Excel</a>
                                            ...
                                            @if(!empty($asyc->iap_d07)&&(!is_null($asyc->iap_d07)))
                                                <td style="color:darkgreen;text-align:center; vertical-align: middle;" title="Constancia de autorización de donaciones">
                                                    <a href="/images/{{$asyc->iap_d07}}" class="btn btn-danger" title="Constancia de autorización de donaciones"><i class="fa fa-file-pdf-o"></i>PDF</a>
                                            ...
                                            @if(!empty($asyc->iap_d08)&&(!is_null($asyc->iap_d08)))
                                                <td style="color:darkgreen;text-align:center; vertical-align: middle;" title="Constancia de cumplimiento de declaración ante el SAT">
                                                    <a href="/images/{{$asyc->iap_d08}}" class="btn btn-danger" title="Constancia de cumplimiento ante el SAT"><i class="fa fa-file-pdf-o"></i>PDF</a>
