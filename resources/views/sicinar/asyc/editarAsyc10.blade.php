            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc10',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc10', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d10)||!is_null($regasyc->iap_d10))  
                                    <div class="col-xs-4 form-group">
                                        <label >Estados financieros en formato excel</label>
                                        <label ><a href="/images/{{$regasyc->iap_d10}}" class="btn btn-success" title="Estados financieros en formato excel"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Estados financieros en formato excel </label>
                                ...
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Estados financieros en formato excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d10" id="iap_d10" placeholder="Subir archivo de Estados financieros en formato PDF" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per10_id" id="per10_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per10_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num10_id" id="num10_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num10_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc10') !!}
@endsection
