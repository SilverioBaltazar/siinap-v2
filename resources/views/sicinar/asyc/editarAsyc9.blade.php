            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc9',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc9', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d09)||!is_null($regasyc->iap_d09))  
                                    <div class="col-xs-4 form-group">
                                        <label >Reporte de cuotas 5 al millar en formato excel</label>
                                        <label ><a href="/images/{{$regasyc->iap_d09}}" class="btn btn-danger" title="Reporte de cuotas 5 al millar en formato excel"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Reporte de cuotas 5 al millar en formato excel</label>
                                ...
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Reporte de cuotas 5 al millar en formato excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d09" id="iap_d09" placeholder="Subir archivo de Reporte de cuotas 5 al millar en formato excel" >
                                    </div>                                                
                                @endif       
                            </div>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per09_id" id="per09_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per09_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num09_id" id="num09_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num09_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc9') !!}
@endsection
