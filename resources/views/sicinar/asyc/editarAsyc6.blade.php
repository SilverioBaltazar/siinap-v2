            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarAsyc6',$regasyc->iap_folio], 'method' => 'PUT', 'id' => 'actualizarAsyc6', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regasyc->iap_d06)||!is_null($regasyc->iap_d06))  
                                    <div class="col-xs-4 form-group">
                                        <label >Programa de trabajo en formato excel</label>
                                        <label ><a href="/images/{{$regasyc->iap_d06}}" class="btn btn-danger" title="Programa de trabajo en formato excel"><i class="fa fa-file-excel-o"></i>Excel</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Programa de trabajo en formato excel</label>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="per06_id" id="per06_id" required>
                                        ...
                                        @foreach($regperiodicidad as $periodicidad)
                                            @if($periodicidad->per_id == $regasyc->per06_id)
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num06_id" id="num06_id" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regasyc->num06_id)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\asycRequest','#actualizarAsyc6') !!}
@endsection
